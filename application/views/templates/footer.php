...
<script src="<?= base_url('assets/js/plugins-init/datatables-adv-init.js'); ?>"></script>
<script src="<?= base_url('assets/js/plugins-init/datatables-api-init.js'); ?>"></script>
<script src="<?= base_url('assets/js/plugins-init/datatables-plugin-init.js'); ?>"></script>
