        ...
        <div class="row">
            <div class="col-12">
                ...
                <div class="card">
                    ...
                    <div class="card-header">
                        <button type="button" class="btn btn-primary" data-toggle="modal" data-target="#modalKomentar">Tambah Data<span class="btn-icon-right"><i class="fa fa-plus"></i></span></button>
                    </div>
                    <div class="card-body">
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <!-- Form Tambah Berita -->
                <form id="formTambahKomentar" action="<?= base_url('admin/komentar/tambah')?>" method="POST">
    ...
    $(document).ready(function () {
        ...
        $('.btn-hapus').click(function () {
            ...
            $('.btn-hapus-confirm').click(function () {
                ...
                window.location.href = '<?= base_url('admin/komentar/delete/') ?>' + idSyarat;
            });
        });
    });
</script>
...
<script>
    // Function to handle emoji click for the update form
    function handleUpdateEmojiClick(formId) {
        const form = document.getElementById(formId);
        const emojis = form.querySelectorAll('.emojis-update li');
        const ratingInput = form.querySelector('input[name="rate"]');
    ...
    // Panggil fungsi untuk formulir update
    handleUpdateEmojiClick('formUpdateKomentar');
</script>
